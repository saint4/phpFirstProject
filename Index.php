            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item carousel-item-five">
                    <div class="container">
                        ...
                        <img class="carousel-position-five animate-delay hidden-sm hidden-xs" src="assets_front/pages/img/shop-slider/slide2/price.png" alt="Price" data-animation="animated zoomIn">
                    </div>
                </div>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 sale-product">
            <h2>New Arrivals</h2>
            <?php 
              $querNew ="Select * From products order by pID DESC Limit 5";
              $newAriv = mysqli_query($con,$querNew);
            ?>
            <div class="owl-carousel owl-carousel5">
            <?php 
                foreach ($newAriv as $dataNew) {
                
                ?>
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="images/<?php echo $dataNew['pImage'] ?>" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets_front/pages/img/products/model1.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html"><?php echo $dataNew['pName'] ?></a></h3>
                  <div class="pi-price"><?php echo $dataNew['pSalePrice'] ?></div>
        ...
        <div class="row margin-bottom-40 ">
          ...
          <div class="sidebar col-md-3 col-sm-4">
            ...
            <?php 
              ...
              $cateData = mysqli_query($con,$catQuery);
              foreach ($cateData as $data) {
            
            ?>
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i><?php echo $data['cName'] ?></a></li>
              <?php } ?>
            </ul>
          </div>
          <!-- END SIDEBAR -->
          ...
          <div class="col-md-9 col-sm-8">
            ...
            <div class="owl-carousel owl-carousel3">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets_front/pages/img/products/k1.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets_front/pages/img/products/k1.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">AKA themeforest</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets_front/pages/img/products/k2.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets_front/pages/img/products/k2.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets_front/pages/img/products/k3.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets_front/pages/img/products/k3.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets_front/pages/img/products/k4.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets_front/pages/img/products/k4.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
            ...
            <div class="owl-carousel owl-carousel2">
              <div>
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.html">product</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
