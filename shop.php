          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row product-list">
              ...
              <?php 
                if(isset($GET['id'])){
                    $id = $_GET['id'];
                    $queryP ="Select * From products where cat = $id";
                }else {
                  $queryP ="Select * From products ";
                }

                $allProduct = mysqli_query($con,$queryP);
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="images/<?php echo $product['pImage'] ?>" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets_front/pages/img/products/model1.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html"><?php echo $product['pName'] ?></a></h3>
                  <div class="pi-price">Rs.<?php echo $product['pSalePrice'] ?></div>
